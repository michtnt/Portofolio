        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              />
              <h1 id="colorlib-logo">
                <a href="index.html">Michelle Tanoto</a>
              </h1>
              <span className="email">
                <i className="icon-mail"></i> michelletanotoo@gmail.com
              </span>
            </div>
            ...
            <div className="colorlib-footer">
              <p>
                <small>
                  Made with <i className="icon-coffee" aria-hidden="true" /> and{" "}
              ...
              <p>
                <small>
                  Software Developer, Academic Tutor, UI/UX Enthusiast and
                  Videographer.
                </small>
              </p>
            </div>
